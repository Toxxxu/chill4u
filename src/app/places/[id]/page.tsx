      ...
      <div className="grid w-full">
        <div className="md:col-span-2">
          <Card>
            ...
            <CardContent>
              <p className="mb-4">
                Experience luxury and relaxation at our beachfront resort.
                Nestled on the pristine shores of Paradise City, our hotel
                offers breathtaking ocean views, world-class amenities, and
                unparalleled service to ensure an unforgettable stay.
              </p>
              ...
              <ul className="list-disc list-inside mb-4">
                ...
                <li>
                  Multiple dining options featuring local and international
                  cuisine
                </li>
              ...
              <Tabs defaultValue="standard">
                ...
                <TabsContent value="standard">
                  <div className="mt-4">
                    ...
                    <p>
                      Comfortable room with all essential amenities. Perfect for
                ...
                <TabsContent value="deluxe">
                  <div className="mt-4">
                    ...
                    <p>
                      Spacious suite with separate living area and premium
                      amenities. Ideal for families or extended stays.
                    </p>
                    <ul className="list-disc list-inside mt-2">
                      <li>King-size bed</li>
                      <li>55&#34; smart TV</li>
                ...
                <TabsContent value="premium">
                  <div className="mt-4">
                    ...
                    <p>
                      Our most luxurious accommodation with stunning ocean views
                      and exclusive perks.
                    </p>
                    <ul className="list-disc list-inside mt-2">
